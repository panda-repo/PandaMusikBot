...
from PandaMusikBot import Telegram, YouTube, app
from PandaMusikBot.misc import SUDOERS
from PandaMusikBot.plugins.play.playlist import del_plist_msg
from PandaMusikBot.plugins.sudo.sudoers import sudoers_list
from PandaMusikBot.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_assistant,
...
from PandaMusikBot.utils.decorators.language import LanguageStart
from PandaMusikBot.utils.inline import help_pannel, private_panel, start_pannel
from PandaMusikBot.utils.command import commandpro
...
@app.on_message(commandpro(["/alive", "Panda"]) & ~filters.edited)
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 Panda chat 💮", url=f"https://t.me/PandaProject_ID")]]
        ),
    )
